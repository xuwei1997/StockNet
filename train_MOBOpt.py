...
class trainMOBOpt(trainStockNet):
    ...
    def write_log(self):
        with open("log_opt_" + str(self.ticker) + ".txt", "a", encoding="utf-8") as f:
            f.writelines(
...
def opt_main(ticker, net_model, n_trials, epoch):
    ...
    with open("log_opt_" + str(ticker) + ".txt", "a", encoding="utf-8") as f:
...
if __name__ == '__main__':
    ...
    # model_list = ['rnn_3_net', 'bp_5_net']
    # ticker_list = ['v1v688012', 'v2v688012', 'v3v688012', 'v4v688012']
    # ticker_list = ['v2v688012', 'v3v688012', 'v4v688012']
    ticker_list = ['002714']
